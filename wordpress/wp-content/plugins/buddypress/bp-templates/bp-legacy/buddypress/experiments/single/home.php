	...
	<div id="item-body">
		...
		if ( bp_experiment_is_visible() ) : 
			...
			if ( bp_is_experiment_home() ) :
                ...
                //elseif ( bp_is_active( 'activity' ) ) : bp_get_template_part( 'experiments/single/testindex' );
                //elseif ( bp_is_active( 'activity' ) ) : bp_get_template_part( 'experiments/single/test.html' );
